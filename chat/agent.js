            ...
            o()(this, e),
              ...
              (this.escapeAndDecorateString = function (txt) {
                var regex = new RegExp(
                  /\w([-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-z0-9]{2,6}\b([-a-z0-9()@:%_\+.~#?&//=]*))/g,
                );
                var match = '';
                var splitText = '';
                var startIndex = 0;
              ...
              (this.empty = function (isConsent, sess, aiMetadata) {
                ...
                na.innerHTML =
                  '<div class="server-icon"><div class="server-icon-img"></div></div><div class="server-response">...</div>';
                var aa;
                if (isConsent) {
              ...
              (this.doReset = function (nr, ttt) {
                ...
                if (
                  !ttt ||
                  typeof ttt === 'undefined' ||
                  typeof ttt.classList !== 'object' ||
                  typeof ttt.classList.contains !== 'function'
                ) {
                  return true;
                }
