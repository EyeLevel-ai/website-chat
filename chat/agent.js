  ...
  !(function (e) {
    ...
    function (e, n, t) {
        ...
        u = (function () {
          function e() {
            o()(this, e),
              ...
              (this.fileUpCnt = this.workplace.getElementById(e.FILE_UP_CNT_ID)),
              (this.fileUpInput = this.workplace.getElementById(e.FILE_UP_INPUT_ID)),
              (this.fileUpButton = this.workplace.getElementById(e.FILE_UP_BUTTON_ID)),
      ...
      (n.a = u),
        ...
        (u.FILE_UP_CNT_ID = 'fileUploadContainer'),
        (u.FILE_UP_INPUT_ID = 'fileUploader'),
        (u.FILE_UP_BUTTON_ID = 'uploadButton'),
            ...
            o()(this, e),
              ...
              (this.escapeAndDecorateString = function (txt, isStreaming) {
                var regex = new RegExp(
                  /(?:https?|ftp):\/\/(?:www\.)?[a-zA-Z0-9][a-zA-Z0-9-]{0,255}(\.[a-z0-9-]{2,})+\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)/g,
                );
                var match = '';
                var splitText = '';
                var startIndex = 0;
              ...
              (this.renderSources = function (message) {
                ...
                // check each object from the response
                ...
                if (n !== 'startWelcome' && n !== 'restartWelcome' && n !== 'reconnect') {
                  ...
                  saveInteraction({
                    ...
                    payload: JSON.stringify({
                      text: t.escapeAndDecorateString(n),
                      rawText: n,
                      type: 'handleInput',
                    }),
                    typing: false,
