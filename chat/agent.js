try {
  ...
  function initModal() {
    ...
    modalContainer.style =
      'display: none;position: fixed; z-index: 9999;left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: rgba(0, 0, 0, 0.5);';
    ...
    modalText.style =
      'margin-top: 16px;margin-bottom: 5px;font-size: 1.0rem; word-break: break-word;';
  ...
  var urlRegex = new RegExp(
    /(?:https?|ftp):\/\/(?:www\.)?[a-zA-Z0-9][a-zA-Z0-9-]{0,255}(\.[a-zA-Z0-9-]{2,})+\b([\-a-zA-Z0-9()@:%_\+.~#?&//=]*)(?<![()\]\.]|\.\.\.)/g,
  );
  ...
  function escapeAndDecorateStreamingString(txt) {
    ...
    while ((match = urlRegex.exec(txt)) != null) {
      ...
      if (
        markdownMatch &&
        markdownMatch.index < match.index &&
        markdownMatch.index + markdownMatch[0].length >= match.index + match[0].length
      ) {
  ...
  function openSourceLinkInSideBar(url, text, index, messageContainerId) {
    ...
    var sideBar = createDivElement({
      id: 'side-bar-' + messageContainerId,
  ...
  function renderSourcesComponent(num, item, name) {
    if (window.eysources === 'thumbnails') {
      return thumbnailsItemComponent(item.pageImagesUrl); // TODO: remove it
    } else {
  ...
  function openXrayModal(searchResultsItem) {
    ...
    // Create File Keywords Accordion
    const fileKeywordsAccordion = createAccordion('File Keywords', searchResultsItem.fileKeywords);
  ...
  function createXrayContentHeader(url, documentId, fileName, pageNumber) {
    // debugger;
  ...
  function loadFilesPreviewInIframe(fileUrl) {
    ...
    iframe.onerror = function (e) {
      ...
      // You can display a fallback message or take other actions here
    };
  ...
  function openSourceLinkInThumbnailsSideBar(searchResultsItem) {
    ...
    if (eyChatDiv) {
      ...
      // var imgContainer = createXrayImageWithBoxes(imgData);
      // this is file form my bucket. I make a mock
      var u = 'https://upload.groundx.ai/dev/file/10000003601/programing%2Blanguage.xlsx';
      var imgContainer = loadFilesPreviewInIframe(u);
      debugger;
  ...
  function createClickableSourceURLs(searchRes, messageContainerId) {
    ...
    if (window.eysources === 'thumbnails') {
      ...
      searchResults.forEach(function (item, index) {
        ...
        var component = linkItemComponent(index + 1, item, item.fileName); // old renderSourcesComponent
        component.onclick = function () {
  ...
  updateUser = function (req) {
    ...
    if (
      !req.session ||
      !req.session.GUID ||
      !req.session.GUID.refUserId ||
      !parseInt(req.session.GUID.aid)
    ) {
      return;
    }
    ...
    if (
      ...
      !user.userId ||
      !user.aid ||
      user.userId != req.session.GUID.refUserId ||
      user.aid != parseInt(req.session.GUID.aid)
    ) {
  ...
  turnUUID = function (sess) {
    if (sess) {
      if (
        sess.TraceNext &&
        sess.TraceNext.turnUUID &&
        sess.TraceNext.turnUUID !== '00000000-0000-0000-0000-000000000000'
      ) {
        return sess.TraceNext.turnUUID;
      } else if (
        sess.Trace &&
        sess.Trace.turnUUID &&
        sess.Trace.turnUUID !== '00000000-0000-0000-0000-000000000000'
      ) {
  ...
  saveSession = function (sess) {
    if (
      ...
      sess.Pos.flowUUID &&
      sess.Pos.turnID &&
      sess.Pos.flowUUID !== '00000000-0000-0000-0000-000000000000' &&
      parseInt(sess.Pos.turnID) !== 0
    ) {
          ...
          if (!msg.isDone && msg.payload && intr.payload) {
            ...
            if (mdata.text) {
              if (idata.text) {
                ...
                idata.attachment &&
                idata.attachment.payload &&
                idata.attachment.payload.text
              ) {
              ...
              mdata.attachment &&
              mdata.attachment.payload &&
              mdata.attachment.payload.text
            ) {
              if (idata.text) {
                ...
                idata.attachment.payload.text =
                  mdata.attachment.payload.text + idata.attachment.payload.text;
                mdata = idata;
              }
            }
  ...
  !(function (e) {
            ...
            ((c = !f && b && void 0 !== b[s]) && s in m) ||
              ...
              (m[s] =
                p && 'function' != typeof b[s]
                  ...
                  ? i(Function.call, l)
                  : l),
              h && (((m.virtual || (m.virtual = {}))[s] = l), e & u.R && y && !y[s] && a(y, s, l)));
        };
      (u.F = 1),
        (u.G = 2),
        (u.S = 4),
    ...
    function (e, n, t) {
        ...
        u = (function () {
          function e() {
            o()(this, e),
              ...
              (this.chatWindow = this.workplace.getElementById(e.CHAT_WINDOW_ID)),
              (this.closeWindow = this.workplace.getElementById(e.CLOSE_WINDOW_ID)),
              ...
              (this.qMenuBtnTR = this.workplace.getElementById(e.QUERY_MENU_ID_TR)),
              (this.qMenuBtnBR = this.workplace.getElementById(e.QUERY_MENU_ID_BR)),
              (this.chatForm = this.workplace.getElementById(e.CHAT_FORM_ID)),
              (this.menuList = this.workplace.getElementById(e.MENU_LIST_ID)),
              (this.menuButton = this.workplace.getElementById(e.MENU_BUTTON_ID)),
              (this.mainMenu = this.workplace.getElementById(e.MAIN_MENU_ID)),
            ...
            a()(
              ...
              [
                  ...
                  value: function (n, ben) {
                    ...
                    t.addEventListener(
                      ...
                      function () {
                        ...
                        if (
                          !userScrolledUp ||
                          q.scrollHeight - q.scrollTop <= q.clientHeight + 20
                        ) {
                    ...
                    if (n.text) {
                      return (
                        (t.className = 'user-request-container'),
                        (t.innerHTML =
                          '<div class="' + e.CLASS_USER_REQUEST + '">' + n.text + '</div>'),
                ...
                },
                {
                  ...
                  value: function (n, t) {
                    return (
                      (t.innerHTML = n), (t.className += ' ' + e.CLASS_SERVER_RESPONSE_ERROR), t
                    );
                  },
                },
                {
      ...
      (n.a = u),
        ...
        (u.MENU_LIST_ID = 'menuList'),
        (u.CHAT_WINDOW_ID = 'eyChat'),
        (u.CLOSE_WINDOW_ID = 'eyMobileChatClose'),
        (u.MENU_BUTTON_ID = 'menuBtn'),
        (u.MAIN_MENU_ID = 'mainMenu'),
        (u.CHAT_FORM_ID = 'agentDemoForm'),
        (u.QUERY_SEND_ID = 'ey-send'),
        (u.QUERY_MENU_ID_TR = 'ey-menu-tr'),
        (u.QUERY_MENU_ID_BR = 'ey-menu-br'),
        (u.CLASS_SEND_ACTIVE = 'active'),
    ...
    function (e, n, t) {
      ...
      e.exports = function (e) {
        ...
        return void 0 === e
          ...
          : null === e
          ? 'Null'
          : 'string' == typeof (t = a((n = Object(e)), o))
          ? t
          : i
          ? r(n)
    ...
    function (e, n, t) {
      ...
      (p && d) ||
        ...
        'process' == t(8)(f)
          ...
          : h
          ? ((o = new h()), (i = o.port2), (o.port1.onmessage = y), (r = a(i.postMessage, i, 1)))
    ...
    function (e, n, t) {
      ...
      var r = t(12),
        ...
        c = (function () {
          function e(n) {
            ...
            o()(this, e),
              (this.domHelper = n),
              (this.handleSend = function (n) {
                n.preventDefault(), n.stopPropagation(), t.checkWS();
              }),
              (this.handleInputKeyDown = function (n) {
                n.keyCode === e.KEY_CODES.ENTER &&
                  (n.preventDefault(), n.stopPropagation(), t.checkWS(n.target.value));
              }),
              ...
              (this.handleWSClose = function (n) {
                ...
                if (
                  window.eySocket &&
                  window.eySocket.connectTime &&
                  (window.eySocket.connectTime + 8000 < now || window.connectAttempts < 4)
                ) {
                  ...
                  if (aa.childNodes.length) {
                    ...
                    for (var j = aa.childNodes.length - 1; j >= 0; j--) {
                      if (aa.childNodes[j].classList.contains('user-request-container')) {
                        ...
                        aa.childNodes[j].classList.contains('server-response-container') &&
                        !aa.childNodes[j].classList.contains('ey-remove-item')
                      ) {
                        le = aa.childNodes[j];
                        break;
                      }
              ...
              (this.processQueue = function () {
                if (window.eySocket.queuedMessages.length) {
                  ...
                  return t.createMessage(wsRes, window.eySocket.typingElement).then(function (r) {
              ...
              (this.processStream = function () {
                if (window.eySocket.streamedMessages.length) {
                  ...
                  return t.renderText(wsRes).then(function (r) {
                    ...
                    if (wsRes) {
                      ...
                      if (wsRes.action) {
                        ...
                        if (wsRes.action === 'reconnect') {
                          ...
                          wsRes.action === 'transfer' ||
                          wsRes.action === 'reconnect-transfer'
                        ) {
                          if (window.eySocket.typingElement) {
                            t.removeItem(window.eySocket.typingElement);
                            delete window.eySocket.typingElement;
                          ...
                          wsRes.action === 'transfer' ||
                          wsRes.action === 'reconnect-transfer-failed'
                        ) {
                          if (window.eySocket.typingElement) {
                            t.removeItem(window.eySocket.typingElement);
                            delete window.eySocket.typingElement;
              ...
              (this.handleMenuClick = function (n) {
                ...
                if (
                  !window.eymenu ||
                  !window.eymenu.pos ||
                  n.target.classList.contains('ey-disabled')
                ) {
                  return;
                }
              ...
              (this.updateResponses = function () {
                ...
                for (var j = aa.childNodes.length - 1; j >= 0; j--) {
                  if (
                    aa.childNodes[j].classList.contains('user-request-container') ||
                    aa.childNodes[j].classList.contains('ey-remove-item')
                  ) {
                    break;
                  } else {
                    ...
                    if (!cn || !cn.length || cn.length !== 1) {
                      ...
                      !cn[0].classList.contains('chat-buttons') &&
                      !cn[0].classList.contains('user-input-wrapper')
                    ) {
                      tc.push(j);
                    } else {
              ...
              (this.loadInteractions = function (idx, inter) {
                ...
                if (int1.sender === 'user') {
                  ...
                  t.createMessage(int1).then(function (ra0) {
              ...
              (this.loadConsent = function () {
                ...
                if (window.consentLoaded || gd === 'true') {
                  ...
                  na.innerHTML =
                    '<div class="consent-container"><table class="ey_result-table"><tr><td id="consentResult"></td></tr></table></div>';
                  q.appendChild(na);
                    ...
                    if (turnUUID) {
                      if (aiMessages[turnUUID] && aiMessages[turnUUID].length) {
                        ...
                        if (msg && msg.metadata && msg.metadata.calcScore) {
                          if (msg.metadata.calcScore > 100.0) {
              ...
              (this.empty = function (isConsent, sess, aiMetadata, checkTID) {
                ...
                na.innerHTML =
                  '<div class="server-icon"><div class="server-icon-img"></div></div><div class="server-response"><div id="animated-dots" style="display: flex; padding-top: 3px; margin-bottom: -3px;"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div>';
                var aa;
                if (isConsent) {
              ...
              (this.saveUserMessage = function (n, typing) {
                ...
                if (n !== 'startWelcome' && n !== 'restartWelcome' && n !== 'reconnect') {
                  window.eySocket.lastInteraction = {
                    action: 'message',
                    payload: JSON.stringify({ text: t.escapeString(n) }),
                    typing: false,
                    sender: 'user',
                  };
                  saveInteraction({
                    ...
                    payload: JSON.stringify({
                      text: escapeAndDecorateString(n),
                      rawText: n,
                      type: 'handleInput',
                    }),
                    typing: false,
              ...
              (this.stage = 'welcome'),
              (this.nextStage = 'welcome'),
              (this.confirmationValue = null),
              (this.menu = null),
              (this.handleMenuButtonClick = function (ben) {
              ...
              (this.chat = {
                      ...
                      function (e) {
                        ...
                        try {
                          ...
                          if (iArr.length === 3) {
                            ...
                            var slider = t.domHelper.workplace.getElementById(
                              'card-slider-' + iArr[2],
                            );
                  ...
                  if (objData.type === 'phone_number') {
                    ...
                    try {
                      ...
                      if (
                        jsonPay &&
                        jsonPay.position &&
                        ((jsonPay.title && jsonPay.action) || jsonPay.type === 'postback')
                      ) {
                ...
                user_input: function (msg) {
                  ...
                  for (var i in payload.quick_replies) {
                    if (
                      payload.quick_replies[i].content_type &&
                ...
                is_input: function (msg) {
                  ...
                  if (data.quick_replies) {
                    for (var i in data.quick_replies) {
                      if (
                        data.quick_replies[i].content_type &&
              ...
              (this.isNullObj = function (obj) {
                return (
                  ...
                  typeof obj.classList !== 'object' ||
                  typeof obj.classList.contains !== 'function'
                );
              }),
              ...
              (this.streamButtons = function (html, isConsent, msgSession, aiMetadata, attempt) {
                if (
                  (!window.eySocket.isStreaming && !window.eySocket.renderingStream) ||
                  attempt > 7
                ) {
                  setTimeout(function () {
                  ...
                  if (!hasInitMenu) {
                    if (window.eymenu && window.eymenu.activate) {
                      if (
                        msg.position &&
                        msg.position.turnID &&
                        window.eymenu.activate == msg.position.turnID
                      ) {
                        hasInitMenu = true;
                        t.enableMenu();
                      }
                  ...
                  if (t.chat.is_input(msg)) {
                    ...
                    if (data.attachment && data.attachment.payload) {
                      if (data.attachment.payload.text) {
                        ...
                        t.setText(
                          t.chat.text(data.attachment.payload.text, isStreaming),
                          ttt,
                          isStreaming,
                          msg.session,
                        );
            ...
            a()(e, [
                ...
                value: function () {
                  ...
                  if (this.domHelper.getQueryInput()) {
                    this.domHelper
                      ...
                      window.shouldOpen && this.handleChatWindow(),
                      this.domHelper
                        .getQueryInput()
                        .addEventListener(
                          'focus',
              ...
              },
              {
                ...
                value: function (ben) {
                  ben.stopPropagation();
                  if (
                    ben.target.className !== 'current-link' &&
                  ...
                  FB.login(
                    function (res) {
                      if (res.authResponse && res.status && res.status === 'connected') {
                        ...
                        var r = t.empty();
                        t.domHelper.setErrorOnNode(
                          'You will have to login and grant authorization to continue.',
                          r,
                        );
                  ...
                  if (!window.isChatting) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        if (window.eySocket.turnType === 'hidden') {
                          ...
                          window.eySocket.lastInteraction = {
                            action: 'message',
                            payload: JSON.stringify({ text: txt }),
                            typing: false,
                            sender: 'user',
                          };
                          saveInteraction({
                      ...
                      saveInteraction({
                        action: 'input_value',
                        payload: JSON.stringify({ input_value: txt, id: dt }),
                        typing: false,
                        sender: 'user',
                      });
                      dt = null;
                    ...
                    if (shouldSend) {
                      ...
                      if (
                        txt === 'reconnect' &&
                        window.eySocket.lastInteraction &&
                        t.chat.is_input(window.eySocket.lastInteraction)
                      ) {
                      } else {
                        delete window.eySocket.turnType;
                        delete window.eySocket.turnID;
                      ...
                      window.isChatting = true;
                      t.removeFeedbackWidget();
                      window.eySocket.send(
                        JSON.stringify(
                          t.buildPayLoad(
                            evt || t.domHelper.getInputValue(),
                            type || 'event',
                            dt,
                            pos,
                          ),
              ...
              },
              {
                ...
                value: function (n, t) {
                  var r = null;
                  (r =
                    n && n.status && n.status.errorDetails
      ...
      (n.a = c),
        (c.DEFAULT_ERROR = 'Sorry, it seems like there was an error during the request.'),
                  ...
                  return new a.a(function (a, u) {
                    ...
                    if (r && n === e.Method.GET) {
                      ...
                      for (var p in r)
                        r.hasOwnProperty(p) &&
                          (f++ && (c += '&'),
                          (c += encodeURIComponent(p) + '=' + encodeURIComponent(r[p])));
    ...
    function (e, n, t) {
      ...
      e.exports = function (e) {
        return function (n, t, a) {
          ...
          } else for (; c > l; l++) if ((e || l in s) && s[l] === t) return e || l || 0;
          return !e && -1;
        };
      };
    },
    ...
    function (e, n, t) {
      e.exports =
        ...
        !t(25)(function () {
          return (
            7 !=
            Object.defineProperty(t(16)('div'), 'a', {
              get: function () {
                return 7;
              },
            }).a
    ...
    function (e, n, t) {
      ...
      e.exports =
        ...
        function (e, n) {
          ...
          return (
            null !== e
              ? ((u.prototype = r(e)), (t = new u()), (u.prototype = null), (t[a] = e))
              : (t = s()),
            void 0 === n ? t : o(t, n)
          );
        };
              ...
              for (var r = e._v, o = 1 == e._s, i = 0; t.length > i; )
                !(function (n) {
                  ...
                  try {
                    a
                      ? (o || (2 == e._h && I(e), (e._h = 1)),
                        !0 === a ? (t = r) : (c && c.enter(), (t = a(r)), c && c.exit()),
                        t === n.promise
  ...
  if (typeof gtag !== 'undefined') {
    gtag('event', window.location.hostname, {
      event_category: 'chat_agent_error',
      event_label: e && e.stack ? e.stack : e,
      uid: userId,
      username: window.username,
      flowname: window.flowname,
      origin: window.origin,
      shouldOpen: window.shouldOpen,
    });
  }
}
