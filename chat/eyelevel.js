...
.ey-section-invisible{opacity:0;transition:max-height 250ms,opacity 250ms ease-in-out;-webkit-transition:max-height 250ms,opacity 250ms ease-in-out;-moz-transition:max-height 250ms,opacity 250ms ease-in-out;-ms-transition:max-height 250ms,opacity 250ms ease-in-out;-o-transition:max-height 250ms,opacity 250ms ease-in-out;}
.ey-section-visible {opacity:1;transition:max-height 250ms,opacity 250ms ease-in-out;-webkit-transition:max-height 250ms,opacity 250ms ease-in-out;-moz-transition:max-height 250ms,opacity 250ms ease-in-out;-ms-transition:max-height 250ms,opacity 250ms ease-in-out;-o-transition:max-height 250ms,opacity 250ms ease-in-out;}
