...
(function() {
  ...
  var eyelevel = {
    init: function(params) {
      ...
      es.innerHTML = `
@keyframes ey-app-container{from{opacity:0;-webkit-transform:scale(.5);-moz-transform:scale(.5);-ms-transform:scale(.5);-o-transform:scale(.5);transform:scale(.5);}to{opacity:1;-webkit-transform:scale(1);-moz-transform:scale(1);-ms-transform:scale(1);-o-transform:scale(1);transform:scale(1);}}.ey-app-container{position:absolute;width:100%;height:100%;z-index:2147483002;cursor:pointer;-webkit-animation:ey-app-container 250ms ease-in-out;-moz-animation:ey-app-container 250ms ease-in-out;-ms-animation:ey-app-container 250ms ease-in-out;-o-animation:ey-app-container 250ms ease-in-out;animation:ey-app-container 250ms ease-in-out;}.ey-app-container:focus{outline:0}
.ey-app{position:fixed;z-index:2147483000;bottom:15px;right:15px;width:100px;height:100px;font-family:Roboto,"Helvetica Neue","Apple Color Emoji",Helvetica,Arial,sans-serif}
...
.ey-container{height:100%;width:100%;${!shouldOpen && "border:1px solid #374050;"}}
.ey-section{display:block;width:100%;height:100%;position:fixed;top:0;left:0;right:0;bottom:0;z-index:2000000000;}
.ey-section-invisible{opacity:0;max-height:0;transition:max-height 250ms,opacity 250ms ease-in-out;-webkit-transition:max-height 250ms,opacity 250ms ease-in-out;-moz-transition:max-height 250ms,opacity 250ms ease-in-out;-ms-transition:max-height 250ms,opacity 250ms ease-in-out;-o-transition:max-height 250ms,opacity 250ms ease-in-out;}
.ey-section-visible {opacity:1;max-height:100%;transition:max-height 250ms,opacity 250ms ease-in-out;-webkit-transition:max-height 250ms,opacity 250ms ease-in-out;-moz-transition:max-height 250ms,opacity 250ms ease-in-out;-ms-transition:max-height 250ms,opacity 250ms ease-in-out;-o-transition:max-height 250ms,opacity 250ms ease-in-out;}
@media(min-width: 451px){
.ey-section{width:376px;min-height:250px;bottom:120px;top:auto;left:auto;right:30px;box-shadow:rgba(0, 0, 0, 0.35) 0px 5px 40px;border-radius: 8px;overflow: hidden;height:calc(100% - 120px);}
.ey-section-visible{max-height:704px;}.ey-section-invisible{max-height:0;}
}
@media(max-width: 450px){
.ey-app-open {display: none;}
}
`;
