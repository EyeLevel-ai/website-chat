...
(function() {
  ...
  if (typeof gtag !== 'undefined') {
    gtag('event', 'chat_ey_error', { event_category: "chat", event_label: (e && e.stack) ? e.stack : e, uid: window.eyuserid, username: window.eyusername, flowname: window.eyflowname, origin: window.eyorigin, channel: window.eychannel, shouldOpen: window.eyshouldopen });
  }
}
