...
/* Copyright */
.copyright a {font-size: 0.8rem;color: #cecece;}body {
...
.lcj-sprite {
  background-image: url('../package/standard/img/chat-sprite.png');
  background-repeat: no-repeat;
  width: 25px;
  height: 25px;
  display: inline-block;
...
.lcj-chat-header.white .lcj-sprite {
  background-image: url('../package/standard/img/chat-sprite-dark.png');
  background-repeat: no-repeat;
  width: 25px;
  height: 25px;
  display: inline-block;
...
.lcj-chat-header.bluelight .lcj-sprite {
  background-image: url('../package/standard/img/chat-sprite-bluelight.png');
  background-repeat: no-repeat;
  width: 25px;
  height: 25px;
  display: inline-block;
...
.lcj-chat-header.white .lcj-sprite {
  background-image: url('../package/standard/img/chat-sprite-white.png');
  background-repeat: no-repeat;
  width: 25px;
  height: 25px;
  display: inline-block;
...
#jrc_chat_output {
  ...
  overflow: auto;
  font-size: 1rem;
  background-image: url('../package/standard/img/loader.gif');
  background-repeat: no-repeat;
...
.loadingbg {
  background: url('../package/standard/img/loadingbg.gif') no-repeat center #dcdcdc !important;
}
